...
public class FrmRegClientes extends javax.swing.JFrame {
    ...
    public void setDatosCliente(int idCliente, String nombre, String apellido, String telefono, String email) {
        idCl = idCliente; 
        txtNomCliente.setText(nombre);
        txtApellCliente.setText(apellido);
        txtTelfCliente.setText(telefono);
    ...
    private void btnModificarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarClienteActionPerformed
        // Validaciones
        if (txtNomCliente.getText().isEmpty() || txtApellCliente.getText().isEmpty() ||
            txtTelfCliente.getText().isEmpty() || txtEmailCliente.getText().isEmpty()) {
