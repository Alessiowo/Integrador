...
public class FrmRegUsuario extends javax.swing.JFrame {
    ...
    public FrmRegUsuario() {
        ...
        lstEmpleados = (ArrayList<Empleado>) objCE.getEmpleado();
        for(Empleado aux : lstEmpleados)
        {
            String cad = aux.getIdEmpleado()+" | "+ aux.getNombreEmp()+" | "+aux.getTurno();
    ...
    private void initComponents() {
        ...
        cbRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cliente", "Empleado", "Administrador" }));
